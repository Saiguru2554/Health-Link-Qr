...
const Register = () => {
  ...
  useEffect(() => {
    ...
    const createShapes = () => {
      const floatingShapes = document.querySelector(".register-floating-shapes");
  ...
  return (
    <div className="min-h-screen creative-healthcare-bg flex flex-col items-center justify-center p-4 relative">
      <div className="register-floating-shapes floating-shapes"></div>
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 w-full max-w-md border border-white/20">
        <h2 className="text-2xl font-semibold mb-6 text-center text-[#0f766e]">Create Account</h2>
        <RegistrationForm />
      </div>
    </div>
  );
